...
-   [Data Collection](#data-case)
-   [I. Importing and Segmenting the Data](#i-importing-and-segmenting-the-data)
-   [II. Data Cleaning](#ii-data-cleaning-applied-to-each-dataset)
-   [III. Feature Engineering](#iii-feature-engineering-applied-to-each-dataset)
-   [IV. Exploratory Data Analysis and Visualization](#iv-exploratory-data-analysis-and-visualization)
-   [V. Model Building](#v-model-building)
-   [VI. Final Test Predictions](#vi-final-test-predictions)
...
3.  Further find the best hyper-parameters for tuning the 3 models selected to get better results. s
